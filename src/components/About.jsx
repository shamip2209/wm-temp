    ...
    export default function About() {
      ...
      return (
        <div className="bg-zinc-900 min-h-screen relative overflow-hidden ">
          {/* Background Blurs */}
          <div className="absolute size-96 left-[1077px] top-[-23px] bg-lime-400 blur-[294px] z-0"></div>
          <div className="absolute size-96 left-[-168px] top-[900px] bg-lime-400 blur-[322px] z-0"></div>
